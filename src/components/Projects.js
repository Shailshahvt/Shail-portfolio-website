...
import { FaGithub, FaReact, FaNodeJs, FaDatabase, FaPython } from 'react-icons/fa';
import './Projects.css';
...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: 'IMDb Ratings Chrome Extension',
      description: 'A lightweight Chrome extension that displays IMDb ratings directly on top of movies and shows while browsing streaming platforms, providing instant access to reviews without leaving the page.',
      image: `${process.env.PUBLIC_URL}/images/imdb-extension.jpg`,
      fallbackImage: 'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=400&h=250&fit=crop&crop=center',
      technologies: ['JavaScript', 'Chrome Extension', 'IMDb API', 'DOM Manipulation'],
      category: 'frontend',
    ...
    },
    {
      ...
      category: 'fullstack',
      github: 'https://github.com/Shailshahvt/Car-Medic',
      featured: true
    },
    {
      id: 3,
      ...
      category: 'backend',
      github: 'https://github.com/Shailshahvt/multisim',
      featured: true
    },
    {
      id: 4,
      ...
      category: 'frontend',
      github: 'https://github.com/Shailshahvt',
      featured: false
    },
    {
      id: 5,
